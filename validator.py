...
meta_conn = sqlite3.connect('metav1.db')
cur = meta_conn.cursor()

# Create the data_meta_v1 table if it doesn't exist
cur.execute('''
...
# Insert the meta information into the data_meta_v1 table for each feature
for feature in features:
...
print(f'Anomalies detected and meta information inserted into data_meta_v1 table.')
